...
export default function NewProductPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await adminProductsApi.createProduct(createData, token!);
    ...
    return (
        <div className="p-8">
            ...
            <div className="mb-8">
                ...
                <h1 className="text-3xl font-bold text-zinc-900">Créer un produit</h1>
                <p className="mt-1 text-zinc-500">Ajoutez un nouveau produit à votre boutique</p>
            </div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="Casque sans fil Pro"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleChange}
                                        className="w-full border border-zinc-200 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                        placeholder="Casque sans fil de haute qualité avec réduction de bruit..."
                                    />
                                </div>
                                                ...
                                                <tr key={index} className="hover:bg-zinc-50 transition">
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <input
                                                            ...
                                                            className="w-32 border border-zinc-200 rounded px-2 py-1 text-sm"
                                                        />
                                                    </td>
                                                    <td className="px-6 py-4">
                                                        <input
                                                            ...
                                                            className="w-24 border border-zinc-200 rounded px-2 py-1 text-sm"
                                                        />
                                                    </td>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="w-full border border-zinc-200 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                        placeholder="Casque sans fil Premium - Meilleure qualité sonore"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleChange}
                                        className="w-full border border-zinc-200 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                        placeholder="Découvrez une qualité sonore premium avec notre casque sans fil doté d'une réduction active du bruit..."
                                    />
                                </div>
                            </div>
                        </div>
